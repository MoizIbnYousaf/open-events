/* eslint-disable */
// Generated by Wrangler by running `wrangler types generated/worker-configuration.d.ts` (hash: 6bc5ad6b772159f10be174a8b4027976)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 
interface __BaseEnv_Env {
	FILES: R2Bucket;
	DB: D1Database;
	START_RECIPIENT_RATE_LIMITER: RateLimit;
	START_SOURCE_RATE_LIMITER: RateLimit;
	ADMIN_LOGIN_RATE_LIMITER: RateLimit;
	TOKEN_REDEEM_SOURCE_RATE_LIMITER: RateLimit;
	TOKEN_REDEEM_TOKEN_RATE_LIMITER: RateLimit;
	ORGANIZER_SEND_RATE_LIMITER: RateLimit;
	RESEND_WEBHOOK_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	ALLOWED_ORIGINS: "https://open-events-acceptance.speakerops.workers.dev" | "https://openevents.engineer,https://www.openevents.engineer,https://open-events.speakerops.workers.dev";
	LOCAL_DEV_MODE: "false";
	DEPLOY_ENVIRONMENT: "acceptance" | "production";
	RESOURCE_D1_ID: "8da9dc8c-7000-4052-b889-e7566514fe8f" | "4983b9bb-cc1c-4ef0-83a6-154b19496909";
	RESOURCE_R2_NAME: "open-events-acceptance-files" | "open-events-production-files";
	PUBLIC_APP_URL: "https://open-events-acceptance.speakerops.workers.dev" | "https://www.openevents.engineer";
	...
	SUBMITTER_CAPABILITY_LEGACY_WRITER_CUTOFF: "2026-08-16T06:31:19.000Z";
	ORGANIZER_SESSION_TTL_MS: "7200000";
	SUBMITTER_SESSION_TTL_MS: "28800000";
	SUBMITTER_TOKEN_TTL_MS: "86400000";
	OPENROUTER_MODEL: "openai/gpt-5.6-luna";
	RATE_LIMIT_ENVIRONMENT: "acceptance" | "production";
	TURNSTILE_HOSTNAMES: "open-events-acceptance.speakerops.workers.dev" | "openevents.engineer,www.openevents.engineer";
	EMAIL_DELIVERY_MODE: "capture" | "resend-live";
	EMAIL_FROM: "" | "Open Events <notifications@openevents.engineer>";
	EMAIL_PAYLOAD_KEY_VERSION: "v1";
	EMAIL_LIVE_VERIFIED_AT: "" | "2026-08-16T06:15:54.000Z";
}
declare namespace Cloudflare {
	...
	interface AcceptanceEnv {
		...
		RESEND_WEBHOOK_RATE_LIMITER: RateLimit;
		ASSETS: Fetcher;
		ALLOWED_ORIGINS: "https://open-events-acceptance.speakerops.workers.dev";
		LOCAL_DEV_MODE: "false";
		...
		PUBLIC_APP_URL: "https://open-events-acceptance.speakerops.workers.dev";
		TOUR_APP_URL: "https://open-events-acceptance.speakerops.workers.dev";
		SUBMITTER_CAPABILITY_WRITER_MODE: "purpose";
		SUBMITTER_CAPABILITY_LEGACY_READER_MODE: "bounded";
		SUBMITTER_CAPABILITY_LEGACY_WRITER_CUTOFF: "2026-08-16T06:31:19.000Z";
		...
		SUBMITTER_TOKEN_TTL_MS: "86400000";
		OPENROUTER_MODEL: "openai/gpt-5.6-luna";
		RATE_LIMIT_ENVIRONMENT: "acceptance";
		TURNSTILE_HOSTNAMES: "open-events-acceptance.speakerops.workers.dev";
