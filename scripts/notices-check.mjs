...
// carries the donor-adaptation marker, and cover every file that ships derived
// glyph artwork.
//
...
// data is the class of attribution that leaves no marker — a single embedded
// path can still be an upstream drawing, and the
...
/** True when `text` contains embedded SVG path data. */
