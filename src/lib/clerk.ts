...
export function isClerkOrganizerPolicyConfigured(value: string | undefined): boolean {
  return value === 'true'
}
...
export function isClerkConfigured(): boolean {
  return (
    ...
    isClerkOrganizerPolicyConfigured(import.meta.env.VITE_CLERK_ORGANIZER_POLICY_CONFIGURED)
  )
}
