...
export const TOUR_STEPS: readonly TourStep[] = [
  moment({
    ...
    body: 'Before we begin, meet Orby, your Open Events assistant. Ask him for help anywhere in the tour. Then follow one DemoConf proposal from intake through review, speaker work, scheduling, and the public programme. Demo access is read-only.',
    access: 'public',
  ...
  moment({
    ...
    body: 'Organizers sign in here. For this tour, Open Events opens a temporary read-only demo workspace automatically.',
    route: '/admin',
    access: 'public',
    target: 'admin-signin',
  ...
  moment({
    ...
    body: 'One proposal connects its answers, speakers, review evidence, decision, onboarding, and schedule placement.',
  ...
  moment({
    ...
    body: 'Uploads stay owner-linked and versioned. Published guides and event links appear in every speaker portal.',
  ...
  moment({
    id: 'orby',
    chapter: 'organizer',
    title: 'Organizer manual support',
    body: 'This is the human support inbox for DemoConf, separate from the floating Ask Orby chat. It keeps attendee questions and organizer replies together.',
